 ...
 Hi there, my name is Kletskov Gleb. I am working as a Frontend Software engineer in  [@yandex](https://github.com/yandex). Recenlty I have worked in [@mailru](https://github.com/mailru) and [@rambler](https://github.com/rambler-digital-solutions) as a TypeScript developer (inner source library for advertisement).

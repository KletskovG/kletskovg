...
![image](https://raw.githubusercontent.com/KletskovG/kletskovg/main/assets/Hi.gif) Hi there, my name is Kletskov Gleb. I am working as Frontend Software engineer in [@mailru](https://github.com/mailru). Recenlty i was woking in [@rambler](https://github.com/rambler-digital-solutions) as TypeScript developer (inner source library for advertisement) and Ingosstrakh (one of the biggest insurance company in CIS).
